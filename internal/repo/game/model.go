...
type Game struct {
	...
	Session   seM.Session       `gorm:"not null;foreignKey:GameSessionID;references:ID;constraint:OnDelete:RESTRICT"`
	...
	Players   []byte            `gorm:"type:jsonb;serializer:json"`
	Data      []byte            `gorm:"type:jsonb;serializer:json"`
