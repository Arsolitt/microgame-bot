...
func TTTStart(creator domainUser.User) (string, error) {
...
func TTTFirstPlayerJoined(creator domainUser.User, firstPlayer domainUser.User) (string, error) {
	var sb strings.Builder
	sb.WriteString(fmt.Sprintf("@%s ", creator.Username()))
	sb.WriteString("запустил игру <b>крестики-нолики</b>")
	sb.WriteString("\n\n")
...
func TTTGameStarted(creator domainUser.User, playerX domainUser.User, playerO domainUser.User) (string, error) {
	var sb strings.Builder
